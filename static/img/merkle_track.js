...
(function(merklesearch, undefined){
   try {
      ...
      function _prepare_ordergif(orderObject, skipPageRefreshCheck){
         ...
         return attr + ( rkglsid ? "&rkglsid=" + encodeURIComponent(rkglsid) : '') + ( mrkgsid ? "&mrkgsid=" + encodeURIComponent(mrkgsid) : '') + "&v=" + version;
      }
      ...
      function _get_attributes_and_set_cookies(mid, cid){
         ...
         param.params = rkglsidParam + mrkgsidParam + srcParam + cidParam + versionParam;
         return param;
      }
